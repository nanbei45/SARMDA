...
m_sim = np.array(m_sim,dtype=float)
d_sim = np.array(d_sim,dtype=float)
data = HeteroData()
...
for epoch in range(0,200):
    ...
    if val_auc > best_val_auc:
        ...
        torch.save(model.state_dict(),"result/data1/data1_GCN_model.pt")
